...
public final class LogConsultaCepFactory {
    ...
    public static LogConsultaCep criarSucesso(
            String cep,
        ...
        return new LogConsultaCep(
                ...
                Objects.requireNonNull(jsonRetorno, "O retorno da API é obrigatório."),
                null);
    }

    public static LogConsultaCep criarCepNaoEncontrado(
            String cep,
            Instant dataHoraConsulta,
            Integer statusHttp,
            JsonNode jsonRetorno) {
    ...
    public static LogConsultaCep criarErroApiExterna(
            String cep,
            Instant dataHoraConsulta,
            Integer statusHttp,
    ...
    private static String validarCep(String cep) {
        String cepNormalizado = Objects.requireNonNull(cep, "O CEP é obrigatório.")
                .replaceAll("\\D", "");

        if (cepNormalizado.length() != 8) {
        	throw new CepInvalidoException("O CEP deve possuir 8 dígitos.");
        }
